defmodule GenRouterx do
  ...
  @callback handle_up({pid, reference}, state :: term) ::
              ...
              | {:stop, reason :: term, new_state :: term, timeout | :hibernate}

  @doc """
  Invoked when a sink cancels subscription or crashed.
  """
  ...
  @doc """
  Invoked to handle all other messages received by router process.
  """
